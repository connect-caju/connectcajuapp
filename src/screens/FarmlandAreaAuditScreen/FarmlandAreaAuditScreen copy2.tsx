...
const FarmlandAreaAuditScreen = ({
  ...
  return (
    ...
    >
      ...
      <Box w="100%" px="3">
        <Stack direction="row" px="3">
          ...
          <Box
            ...
            alignItems={"flex-end"}
            // @ts-expect-error TS(2322): Type '{ children: false | Element; w: "50%" | "0%"... Remove this comment to see the full error message
            style={{
              flex: 1,
              justifyContent: "center",
            }}
      ...
      />
      <Center
        // @ts-expect-error TS(2322): Type '{ children: false | Element; style: { paddin... Remove this comment to see the full error message
        style={{
          paddingVertical: 10,
        }}
      >
