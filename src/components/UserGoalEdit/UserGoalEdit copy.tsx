        ...
        >
          <Stack w="100%" py="4" direction="row">
            <Box>
              ...
              >
                <Icon name="arrow-back" color={COLORS.grey} size={wp("8%")} />
              </Pressable>
            </Box>
            <Box
            ...
            >
              <Text className="text-center text-gray-600 font-bold text-lg">
          ...
          >
            {(!district || districtalUsers.length === 0) && <GoalSetting />}
            {!district && (
              <Text className="text-center font-normal text-sm text-gray-400">
            ...
            {district && districtalUsers.length === 0 && (
              <View className="w-60">
                <Text className="text-center font-normal text-sm text-red-400">
          ...
          {district && districtalUsers.length > 0 && (
            <View>
              <View className="flex flex-row justify-between items-center my-1 border-t border-x pt-3 rounded-t-lg px-0.5 ">
                <View className="w-2/5" >
                  <Text className="font-normal text-xl text-black dark:text-white">
                    Usuário
                  </Text>
                </View>
                ...
                <View
                  className="flex justify-center items-center pr-0.5"
                >
                  <Text className="font-normal text-sm text-black dark:text-white ">
                    Acção
                  </Text>
              ...
              >
                {Array(20).fill(districtalUsers[0]).flat()?.map((userItem) => {
