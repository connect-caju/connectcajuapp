...
import { ActorFormDataTypes, UserDetails } from "../lib/types";
...
export const buildActorObject2 = (
  actorData: ActorFormDataTypes,
  userDetails: UserDetails,
) => {
  const {
  ...
  let identifier = generateUniqueNumber(userDetails.userDistrict!, farmerTypes.farmer);
